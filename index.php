...
<? php
    ...
    //PRIMERA PARTE
    // $edad = (string) '';
    // if(!isset($edad)) echo "La variable edad no existe <br>";
    // if(is_null($edad)) echo "La variable edad existe pero su tipo de dato y dato es null <br>";
    // if(empty($edad)) echo "la variable edad existe y su dato en vacío <br>";
?>